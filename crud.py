...
def insert():
    ...
    if(id=="" or name=="" or phone==""):
        ...
        con=mysql.connect(host="localhost",password="123456",user="root",database="sit");
        cursor=con.cursor()
        query="insert into crud values(%s,%s,%s)"
...
def update():
    ...
    if(id=="" or name=="" or phone==""):
        ...
        con=mysql.connect(host="localhost",password="123456",user="root",database="sit");
        cursor=con.cursor()
        query="update crud set name=%s,phone=%s where id=%s"
...
def delete():
    ...
    con=mysql.connect(host="localhost",password="123456",user="root",database="sit");
    cursor=con.cursor()
    query="delete from crud where id=%s and name=%s"
...
showdata=Button(root,text="showdata",command=showdata)
showdata.grid(column=3,row=4)
tree=ttk.Treeview()
tree["columns"]=["email","name","phone"]
tree.column("email",width=50,minwidth=110,anchor="w")
tree.column("name",width=50,minwidth=110,anchor="w")
tree.column("phone",width=50,minwidth=110,anchor="w")
